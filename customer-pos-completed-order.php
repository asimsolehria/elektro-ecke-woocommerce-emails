...
/**
 * Customer POS completed order email (receipt)
 *
 * New in WooCommerce: sent when an in-person sale via WooCommerce
 * Point of Sale is completed. Functions as a digital receipt, so there's
 * no "shipped" tracker &mdash; the customer already has the goods in hand.
 *
				...
				<td valign="top" class="em_side_space">
					<table width="100%" border="0" cellspacing="0" cellpadding="0">
						...
						<tr>
							...
							<?php esc_html_e('Thanks for shopping with us in-store! Here\'s your receipt for the record.', 'e-mail-strings'); ?> </td>
						</tr>
						<tr>
							<td height="10" style="line-height:1px;font-size:1px;">
								&nbsp;</td>
...
/*
 * Fired for POS receipts so store address/phone can be appended if set.
 *
 * @hooked - none by default in core; kept for parity with WooCommerce POS.
 */

				...
				<td valign="top" class="em_side_space">
					<table width="100%" border="0" cellspacing="0" cellpadding="0">
						...
						<tr>
							...
							<?php printf(esc_html__('Notification to let you know &mdash; order #%1$s belonging to %2$s has been cancelled:', 'e-mail-strings'), esc_html($order->get_order_number()), esc_html($order->get_formatted_billing_full_name())); ?> </td>
						</tr>
						<tr>
							<td height="10" style="line-height:1px;font-size:1px;">
								&nbsp;</td>
						...
						<tr>
							<td class="em_grey_txt" style="font-family: 'Outfit', sans-serif;font-size:19px;text-align:center;padding-left:0px;padding-right:0px;color:#1F2548;line-height:27px;font-weight:600;">
								<?php esc_html_e('Order number is:', 'e-mail-strings'); ?> <?php echo $order->get_order_number(); ?>,
							</td>
						</tr>

 ...
 *
 * New in WooCommerce: a customer-facing version of the failed order
 * notice (previously this only went to the admin), with a retry-payment CTA.
 *
...
<tr>
				...
				<td valign="top" class="em_side_space">
					<table width="100%" border="0" cellspacing="0" cellpadding="0">
						...
						<tr>
							...
							<?php printf(esc_html__('Unfortunately we weren\'t able to process payment for order #%s. No charge has been made &mdash; you can try again using the button below.', 'e-mail-strings'), esc_html($order->get_order_number())); ?> </td>
						</tr>
						<tr>
							<td height="10" style="line-height:1px;font-size:1px;">
								&nbsp;</td>
    ...
    width: auto' href="<?php echo esc_url($order->get_checkout_payment_url()); ?>"> <?php esc_html_e('Retry Payment', 'e-mail-strings') ?>
				</a>
			</div>
		</td>
	</tr>

 ...
 *
 * New in WooCommerce: sent when a customer adds or changes the email
 * address on their account, asking them to confirm ownership of the new
 * address before it's applied.
 *
 ...
 * version; this template checks for $user_login and $verification_url defensively.
 *
...
$greet_name = isset($user_login) ? $user_login : '';
?>
...
<tr>
					...
					<table width="100%" border="0" cellspacing="0" cellpadding="0">
						...
						<tr>
							<td class="resize" style=" font-family: 'Outfit', sans-serif;font-size:31px;text-align:center;color:#1F2548;font-weight:700;line-height: 45px;">
								Hello<?php echo $greet_name ? ' ' . esc_html($greet_name) : ''; ?>, </td>
						</tr>
						<tr>
						...
						<tr>
							...
							<?php printf(esc_html__('Please confirm this is your email address to finish updating your account on %s.', 'e-mail-strings'), esc_html(wp_specialchars_decode(get_option('blogname'), ENT_QUOTES))); ?> </td>
						</tr>
						<tr>
    ...
    width: auto' href="<?php echo esc_url($verify_url); ?>"> <?php esc_html_e('Verify Email Address', 'e-mail-strings') ?>
				</a>
			</div>
		</td>
	</tr>
						...
						<tr>
							<td class="nopad" style="font-family: 'Outfit', sans-serif;font-size:13px;text-align:center;color:#696969;font-weight:400;line-height: 20px;">
								<?php esc_html_e('If you didn\'t request this change, you can safely ignore this email and your account will be unaffected.', 'e-mail-strings'); ?>
							</td>
						</tr>

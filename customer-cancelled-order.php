 ...
 *
 * New in WooCommerce: a customer-facing version of the cancelled order
 * notice (previously this only went to the admin).
 *
...
<tr>
				...
				<td valign="top" class="em_side_space">
					<table width="100%" border="0" cellspacing="0" cellpadding="0">
						...
						<tr>
							...
							<?php printf(esc_html__('We wanted to let you know that your order #%s has been cancelled. If you weren\'t expecting this, please get in touch with us and we\'ll sort it out for you.', 'e-mail-strings'), esc_html($order->get_order_number())); ?> </td>
						</tr>
						<tr>
							<td height="10" style="line-height:1px;font-size:1px;">
								&nbsp;</td>
    ...
    width: auto' href="<?php echo esc_url(wc_get_page_permalink('shop')); ?>"> <?php esc_html_e('Continue Shopping', 'woocommerce') ?>
				</a>
			</div>
		</td>
	</tr>
